...
export const DOCK_CONTROL_ORDER_DEFAULT = ["source", "translate", "romanize", "offset", "refresh", "pictureInPicture"] as const;
...
export const SMOOTH_PROGRESS_BAR_STYLE_ID = "blyrics-smooth-progress-bar" as const;
